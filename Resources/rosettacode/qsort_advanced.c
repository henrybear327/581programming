/*The implementation in the core implementations section is limited to arrays of integers. The
/*following implementation works with any data type, given its size and a function that compares it.
/*This is similar to what ISO/POSIX compliant C standard libraries provide:*/
